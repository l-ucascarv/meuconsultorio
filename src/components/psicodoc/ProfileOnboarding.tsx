          ...
          {step === 'consent' && (
            <div className="space-y-4">
              <div className="bg-muted rounded-xl p-4 text-xs text-muted-foreground space-y-2 max-h-48 overflow-y-auto">
                ...
                <p>
                  Ao utilizar o <strong>Meu Consultório</strong>, você autoriza o uso dos seguintes
                  dados obtidos através do seu cadastro:
                </p>
                <ul className="list-disc pl-4 space-y-1">
                  <li><strong>Nome e e-mail</strong> — para identificação e comunicação na plataforma.</li>
                  <li><strong>CRP e especialidade</strong> — para emissão de documentos psicológicos conforme as normas do CFP.</li>
                  <li><strong>Dados de pacientes</strong> — armazenados de forma segura e acessíveis somente por você.</li>
                </ul>
                <p>
                  Seus dados são protegidos conforme a <strong>LGPD (Lei Geral de Proteção de Dados)</strong> e
                  não serão compartilhados com terceiros sem sua autorização prévia.
                </p>
                <p>
                  Você pode solicitar a exclusão dos seus dados a qualquer momento entrando em contato
                  com o suporte da plataforma.
                </p>
              </div>
              ...
              <label className="flex items-start gap-3 cursor-pointer">
                ...
                <span className="text-xs text-foreground leading-relaxed">
                  ...
                  <strong>Política de Privacidade</strong>, autorizando o uso dos meus dados
          ...
          {step === 'professional' && (
            <div className="space-y-4">
              <div className="space-y-1.5">
                ...
                />
                {errors.crp && (
                  <p className="text-destructive text-xs">{errors.crp}</p>
                )}
              </div>
